...
//	innerClass ကို ဘယ်လိုတွေသုံးလဲဆိုရင် ဥပမာ - class တစ်ခုထဲမှာ name, NRC ဆိုပြီးရှိတယ် NRC ထဲမှာမှ string, Integer တွေ
...
//		Anonymous.java Interface Class ထဲက testing ဆိုတဲ့ abstract method ကိုအောက်မှာ 3 မျိုးခေါ်သုံးမယ်
...
//		interface Anonymous ထဲက method တွေက abstract method တွေဖြစ်လို့ method overriding ကတော့ပြန်လုပ်ပေးရမယ်
...
//		object တစ်ခုဆောက်ပြီးမှ anonymous class အနေနဲ့ခေါ်သုံးခြင်းတို့၏ ကွာခြားချက်က-----
...
//		နောက်ဆုံးနည်းကတော့ Lambda Expression
